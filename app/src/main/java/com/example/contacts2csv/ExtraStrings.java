...
public class ExtraStrings {
    ...
    public static final String HELP_MESSAGE =
            "CSV联系人导入导出工具 1.2.1安卓版(20200225)\n" +
                    ...
                    "\n" +
                    "    许多手机、平板等设备自带联系人备份功能都有诸多限制，只适用于特定手机导入导出、备份文件加密不能编辑加工等。本软件可以帮你快速备份联系人，不用担心号码遗失，软件操作简单，使用方便。\n" +
                    "1、主要特点\n" +
                    "    (1)、导出的信息是 csv(Comma Separated value) 格式文本文件，可以使用文本编辑器、Excel 等进行编辑处理\n" +
                    "    (2)、导出时将自动生成类似 Contacts_X.txt 的不重复文件名，避免覆盖已有文件\n" +
                    "    (3)、可以从备份文件中导入联系人记录\n" +
                    "    (4)、导入时可以自动选择类似 Contacts_X.txt 的最新文件名，也可以浏览选择指定文件进行导入\n" +
                    "    (5)、导入时已禁用安卓自带的同名聚合，避免丢失许多同名联系人信息\n" +
                    "    (6)、导入和删除时，可以选择是否处理联系人群组信息\n" +
                    "    (7)、导入导出时，会自动为匿名用户添加类似 anonymous_X 的用户名\n" +
                    "    (8)、导入导出时，会剔除无任何信息的空白记录，可以选择剔除仅含姓名、无其他信息的记录\n" +
                    "    (9)、导入导出时，会自动将文件路径复制到剪贴板中，以供用户使用\n" +
                    "    (10)、导入导出时，程序将会自动处理安卓联系人14个类型100多个字段的信息\n" +
                    "    (11)、可以快速删除通讯录所有联系人和群组信息\n" +
                    "    (12)、在导入、导出和删除众多记录时，能够显示处理总数，实时显示处理成功和失败的记录条数、已用时间等信息\n" +
                    "\n" +
                    "2、导出联系人\n" +
