...
public class ExtraStrings {
    ...
    public static final String HELP_MESSAGE =
            "CSV联系人导入导出工具 1.2.1安卓版(20200225)\n" +
                    ...
                    "1、主要特点\n" +
                    "    (1)、导出的信息是 csv(Comma Separated value，逗号分隔数据) 格式文本文件，可以使用文本编辑器、Excel 等进行编辑处理\n" +
                    ...
                    "    若选择导出用户头像，图片文件将存放在程序私有目录下的 photo 子目录中，文件名是以用户名称命名。\n" +
                    "    \n" +
                    "3、删除联系人\n" +
                    ...
                    "    若选择导入用户头像，请将图片文件放在程序私有目录下的 photo 子目录中。文件名可以是用户名称、也可以是 Contacts_X.txt 文件中 photo 字段的值，注意将文件名中的空格全部替换为下划线。图像格式可选 png、jpg、bmp，图像质量可选 1-100。\n" +
                    "    \n" +
                    "5、程序私有目录\n" +
